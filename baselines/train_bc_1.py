...
if __name__ == '__main__':
    ...
    human_data_dir = "./full_human_data"
    TOTAL_DIRS = [
        "DATA_RELEASE_0",
        "DATA_RELEASE_1",
        "DATA_RELEASE_2",
    ...
    # print(file_pointers)
    tb_writer = SummaryWriter(f"./output_bc1/logs/")
    wrapper = BCWrapper({})
    policy = Policy()
    num_epochs = 100000
    for epoch in range(num_epochs):
        try: # avoid file read error
            ...
            if epoch % 2000 == 0:
                ...
                policy.save_model(f"./output_bc1/bc_model_{epoch}")
        except Exception as e:
            logging.warning(f"ignored exception @update: {traceback.format_exc()}")
